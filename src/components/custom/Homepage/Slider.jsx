...
const Slider = ({ response }) => {
  ...
  return (
    <div className="w-full overflow-hidden mb-20">
      ...
      {/* Large Screens */}
      <div className="mt-4 hidden md:flex h-auto justify-center items-center relative">
        <Swiper
          key={swiperKey}
      ...
      {/* Small Screens */}
      <div className="mt-4 block md:hidden h-auto w-full relative">
        <Swiper
          key={swiperKey}
          modules={[Autoplay, Navigation]}
          autoplay
              ...
              <div className="flex flex-col items-center">
                ...
                >
                  ...
                  <div className="mt-4 text-center">
                    ...
                    <p className="font-secondary text-sm">{img.description}</p>
                  </div>
                </a>
              </div>
            </SwiperSlide>
