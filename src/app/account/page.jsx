...
const CustomerAccount = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      description:
        "You can use your store credit to buy products during checkout.",
    },
  ];
                ...
                {card.link ? (
                  <Link href={card.link}>
                    <div className="space-y-1 mt-2 cursor-pointer">
                      ...
                      <p className="text-[#808080] text-sm flex-grow">
                        {card.description}
                      </p>
                      {card.buttonText && (
      ...
      <div className="max-w-5xl mx-auto min-h-screen flex items-center py-10 px-4 md:px-6 lg:px-8">
        <div className="w-full max-w-3xl bg-white p-6 sm:p-8">
          ...
          <div className="mb-8 flex flex-col md:flex-row">
            <h2 className="text-lg font-semibold md:w-1/4 mb-4 sm:mb-0">
              Information
            </h2>
            <div className="md:w-3/4">
              ...
              <div className="flex flex-col md:flex-row justify-between mb-10">
                ...
                <div>
                  ...
                  <Link
                    href="/customer/account/sms/"
                    className="text-black hover:underline cursor-pointer mt-1"
                  >
                    Manage
                  </Link>
                </div>
                  ...
                  <div className="flex flex-col md:flex-row justify-between mb-10">
                    ...
                    <div>
                      ...
                      <div className="flex flex-col space-y-1">
                        <p className="text-gray-600 text-left whitespace-nowrap">
                          lorem ipsum
                        </p>
                        <p className="text-gray-600 text-left whitespace-nowrap">
                          lorem ipsum
                      ...
                      <Link
                        href="/customer/account/sms/"
                        className="text-black hover:underline cursor-pointer mt-1 block"
                      >
          ...
          <div className="mb-10 flex flex-col md:flex-row">
            <h2 className="text-lg font-semibold md:w-1/4 mb-4 md:mb-0">
              Payment
            </h2>
            <div className="md:w-3/4">
              <p className="font-medium">Stored Cards</p>
              <p className="text-gray-600 whitespace-nowrap">
                You can store your credit cards
                <br /> securely for a faster checkout.
              </p>
              <Link
                href="/stripe/customer/cards/"
                className="text-black hover:underline cursor-pointer mt-1"
              >
                Add a card
              </Link>
