...
const BanglesBraceletsPage = () => {
  ...
  const generateBreadcrumbs = () => {
    const pathSegments = ["home", "jewellery", "Bangles & Bracelets"];
                ...
                filters
                  ?.filter((filter) => {
                    ...
                    return filter.categories.some((category) =>
                      categories.includes(category.name.toLowerCase())
                    );
                  })
...
export default BanglesBraceletsPage;
