...
const SubCategoryPage = () => {
  ...
  const bannerIndexMap = {
    ...
    "oval-bracelet": 44,
    "tennis-bracelet": 45,
    "mangalsutra-bracelet": 46,
    "evil-eye-bracelet": 47,
  };
  ...
  const generateBreadcrumbs = () => {
    const formattedStyle = subCategory
      .replace(/-/g, " ")
    ...
    const pathSegments = [
      ...
      { title: formattedCategory, href: `/jewellery/bangles-bracelets` },
      { title: heading, href: `/jewellery/bangles-bracelets/${subCategory}` },
    ];
    return pathSegments;
  };
                ...
                filters
                  ?.filter((filter) => {
                    ...
                    return filter.sub_categories.some(
                      (cat) =>
                        subCategory ===
                        cat.name.toLowerCase().replace(/ /g, "-") // Match exact subCategory
                    );
                  })
