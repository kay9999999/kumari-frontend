...
const EarringsPage = () => {
  ...
  const category = "earrings"; // Dynamically set the category here for different pages
  ...
  const generateBreadcrumbs = () => {
    const pathSegments = ["home", "jewellery", "earrings"];
              ...
              {filtersLoading ? (
                ...
                filters
                  ?.filter((filter) => {
                    ...
                    return filter.categories.some((cat) =>
