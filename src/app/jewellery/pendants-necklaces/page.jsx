...
const PendantsNecklacesPage = () => {
  ...
  const generateBreadcrumbs = () => {
    const pathSegments = ["home", "jewellery", "Pendants & Necklaces"];
...
export default PendantsNecklacesPage;
